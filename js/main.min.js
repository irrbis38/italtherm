...
var initYoutubeVideo=e=>{e.forEach(r=>{var e=r.dataset.video,o=e.substring("https://youtu.be/".length,e.length),a=r.parentElement;a.querySelector(".video-play-btn").addEventListener("click",()=>{t=o,(e=document.createElement("iframe")).classList.add("video-iframe"),e.setAttribute("src","https://www.youtube.com/embed/"+t+"?rel=0&showinfo=0&autoplay=1"),e.setAttribute("title","YouTube video player"),e.setAttribute("frameborder","0"),e.setAttribute("allowfullscreen",""),e.setAttribute("allow","accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope;");var e,t=e;a.querySelector(".video-preview").remove(),r.append(t)})})},togglePolicy=()=>{var t=document.querySelector(".policy"),e=document.querySelector(".footer__policy"),r=document.querySelectorAll(".close-policy");e.addEventListener("click",()=>{t.classList.add("active"),document.body.classList.add("lock")}),r.forEach(e=>{e.addEventListener("click",()=>{t.classList.remove("active"),document.body.classList.remove("lock")})})},initInputCheck=e=>{e.forEach(e=>{e.addEventListener("input",()=>{e.classList.remove("error")})})},doFormValidation=(e,t,r)=>{e=e.filter(e=>e.required);0<e.length&&e.forEach(e=>{e.value?e.classList.remove("error"):e.classList.add("error")}),0<t.length&&t.forEach(e=>{e.value&&(/^(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/.test(String(e.value).toLowerCase())?e.classList.remove("error"):e.classList.add("error"))}),0<r.length&&r.forEach(e=>{e.value&&(16===e.value.length?e.classList.remove("error"):e.classList.add("error"))})},checkErorrs=e=>{return!e.some(e=>e.classList.contains("error"))};document.addEventListener("DOMContentLoaded",()=>{var e=Array.from(document.querySelectorAll(".video-block"));0<e.length&&initYoutubeVideo(e),togglePolicy()});