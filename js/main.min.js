...
"use strict";var initYoutubeVideo=e=>{e.forEach(r=>{var e=r.dataset.video,o=e.substring("https://youtu.be/".length,e.length),i=r.parentElement;i.querySelector(".video-play-btn").addEventListener("click",()=>{t=o,(e=document.createElement("iframe")).classList.add("video-iframe"),e.setAttribute("src","https://www.youtube.com/embed/"+t+"?rel=0&showinfo=0&autoplay=1"),e.setAttribute("title","YouTube video player"),e.setAttribute("frameborder","0"),e.setAttribute("allowfullscreen",""),e.setAttribute("allow","accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope;");var e,t=e;i.querySelector(".video-preview").remove(),r.append(t)})})},togglePolicy=()=>{var t=document.querySelector(".policy"),e=document.querySelectorAll(".show-policy"),r=document.querySelectorAll(".close-policy");e.forEach(e=>{e.addEventListener("click",()=>{t.classList.add("active"),document.body.classList.add("lock")})}),r.forEach(e=>{e.addEventListener("click",()=>{t.classList.remove("active"),document.body.classList.remove("lock")})})},initInputCheck=e=>{e.forEach(e=>{e.addEventListener("input",()=>{e.classList.remove("error")})})},doFormValidation=e=>{e=e.filter(e=>e.required);0<e.length&&e.forEach(e=>{e.value?e.classList.remove("error"):e.classList.add("error")})},checkErorrs=e=>{return!e.some(e=>e.classList.contains("error"))},initFormValidation=t=>{var r,o=document.querySelector(".feedback__form");o&&(0<(r=Array.from(o.querySelectorAll(".feedback__input"))).length&&initInputCheck(r),o.addEventListener("submit",e=>{e.preventDefault(),doFormValidation(r),checkErorrs(r)&&(o.reset(),t.classList.add("success"))}))};document.addEventListener("DOMContentLoaded",()=>{var e=Array.from(document.querySelectorAll(".video-block")),e=(0<e.length&&initYoutubeVideo(e),togglePolicy(),document.querySelector(".feedback"));e&&initFormValidation(e)});